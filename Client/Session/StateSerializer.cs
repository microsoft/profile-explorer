...
namespace Client {
    static class StateSerializer {
        ...
        public static List<HighlightedSegmentGroup> LoadElementGroupState(List<ElementGroupState> groupStates) {
        ...
        static public void PatchIRElementObjects(object value, FunctionIR function) {
            if (value == null) {
                return;
            }
