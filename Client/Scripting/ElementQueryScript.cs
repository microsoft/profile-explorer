...
namespace Client.Scripting
{
    ...
    public class QueryValue : BindableObject
    {
        ...
        {
            get => warningMessage_; set => SetAndNotify(ref warningMessage_, value);
        }
    ...
    public class QueryData : INotifyPropertyChanged
    {
        ...
        void InputValueChanged(object sender, PropertyChangedEventArgs e)
        {
        ...
        {
            AddInput(new QueryValue(name, QueryValue.GetDefaultValue(kind),
                                    kind | QueryValueKind.Input, description));
        }
    ...
    public class BuiltinElementQuery : IElementQuery
    {
        ...
        public bool Execute(QueryData data)
        {
            ...
            data.SetOutput("Output A", (new Random().NextDouble() > 0.5 ? true : false));
            data.SetOutput("Output B", (new Random().NextDouble() > 0.5 ? true : false));
