    ...
    static class Minidump {
        ...
        public static bool WriteDump(SafeHandle fileHandle, Option options,
            ...
            if (exceptionInfo == ExceptionInfo.Present) {
                exInfo.ExceptionPointers = System.Runtime.InteropServices.Marshal.GetExceptionPointers();
            }

            if (exInfo.ExceptionPointers == IntPtr.Zero) {
                return MiniDumpWriteDump(currentProcessHandle, currentProcessId,
                                         fileHandle, (uint)options, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero);
            }
            else {
                return MiniDumpWriteDump(currentProcessHandle, currentProcessId,
                                         fileHandle, (uint)options, ref exInfo, IntPtr.Zero, IntPtr.Zero);
            }
        }
