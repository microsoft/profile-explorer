...
namespace Client {
    ...
    public partial class SourceFilePanel : ToolPanelControl {
        ...
        public SourceFilePanel() {
            ...
            TextView.TextArea.TextView.BackgroundRenderers.Add(new
                CurrentLineHighlighter(TextView, lineBrush, Pens.GetPen(Colors.Gray)));
        }
        ...
        public override void OnElementSelected(IRElementEventArgs e) {
            ...
            if (tag != null &&
               tag.Line >= 0 &&
               tag.Line <= TextView.Document.LineCount) {
