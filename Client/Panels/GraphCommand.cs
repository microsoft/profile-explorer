...
namespace Client {
    public static class GraphCommand {
        ...
        public static readonly RoutedCommand MarkBlock =
            new RoutedCommand("MarkBlock", typeof(GraphPanel));
        ...
        public static readonly RoutedCommand MarkGroup =
            new RoutedCommand("MarkGroup", typeof(GraphPanel));
        public static readonly RoutedCommand MarkLoop =
            new RoutedCommand("MarkLoop", typeof(GraphPanel));
