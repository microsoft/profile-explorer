...
namespace Client {
    ...
    public partial class PassOutputPanel : ToolPanelControl, INotifyPropertyChanged {
        string initialText_;
        bool showAfterOutput_;
        bool searchPanelVisible_;
        List<TextSearchResult> searchResults_;
        ...
        private void SaveState(IRTextSection section, IRDocument document) {
            ...
            var data = StateSerializer.Serialize<PassOutputPanelState>(state, document.Function);
        ...
        private async void FilterComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e) {
            ...
            switch (kindString) {
                case "Before": showAfterOutput_ = false; break;
                case "After": showAfterOutput_ = true; break;
            }
