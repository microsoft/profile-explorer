...
msbuild %_PROFILER_PATH%\ManagedProfiler.vcxproj /t:Rebuild /p:Configuration=%_BUILD_CONFIG% /p:Platform=arm64 || exit /b 1
copy %_PROFILER_PATH%\arm64\%_BUILD_CONFIG%\ManagedProfiler.dll %_OUT_PATH% || exit /b 1
