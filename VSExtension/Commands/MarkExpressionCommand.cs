...
namespace IRExplorerExtension
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class MarkExpressionCommand : CommandBase
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private MarkExpressionCommand(AsyncPackage package, OleMenuCommandService commandService) : base(package)
        {
        ...
        /// </summary>
        public static MarkExpressionCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            var variable = await GetCaretDebugExpression();
        ...
        public async Task<bool> Execute(string expression, bool temporary)
        {
            if (expression != null)
            {
                ...
                var elementAddress = DebuggerInstance.ReadElementAddress(expression);
                return await ClientInstance.RunClientCommand(() =>
                                  ClientInstance.debugClient_.ExecuteCommand(new ElementCommandRequest() { 
                                      ...
                                      Label = expression,
                                      Highlighting = temporary ? HighlightingType.Temporary : HighlightingType.Permanent,
