...
namespace IRExplorerExtension
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class MarkReferencesCommand : CommandBase
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private MarkReferencesCommand(AsyncPackage package, OleMenuCommandService commandService) : base(package)
        {
        ...
        /// </summary>
        public static MarkReferencesCommand Instance
        {
            get;
            private set;
        }
        ...
        private async void Execute(object sender, EventArgs e)
        {
            ...
            {
                var elementAddress = DebuggerInstance.ReadElementAddress(variable);
