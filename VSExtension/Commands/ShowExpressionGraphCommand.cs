...
namespace IRExplorerExtension
{
    ...
    internal sealed class ShowExpressionGraphCommand : CommandBase
    {
        ...
        private ShowExpressionGraphCommand(AsyncPackage package, OleMenuCommandService commandService) : base(package)
        {
        ...
        /// </summary>
        public static ShowExpressionGraphCommand Instance
        {
            get;
            private set;
        }
