...
namespace IRExplorerExtension
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class MarkUsesCommand : CommandBase
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private MarkUsesCommand(AsyncPackage package, OleMenuCommandService commandService) : base(package)
        {
        ...
        /// </summary>
        public static MarkUsesCommand Instance
        {
            get;
            private set;
        }
