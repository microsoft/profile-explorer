...
namespace IRExplorerExtension
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class ShowReferencesCommand : CommandBase
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private ShowReferencesCommand(AsyncPackage package, OleMenuCommandService commandService) : base(package)
        {
        ...
        /// </summary>
        public static ShowReferencesCommand Instance
        {
            get;
            private set;
        }
