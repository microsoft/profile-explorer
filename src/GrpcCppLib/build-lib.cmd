...
copy %VCPCKG_PATH%\installed\x64-windows\bin\libcrypto-1_1-x64.dll %cd%\GrpcCppLib\x64\ReleaseDLL
...
copy %VCPCKG_PATH%\installed\x86-windows\bin\libcrypto-1_1.dll %cd%\GrpcCppLib\ReleaseDLL
