...
public static class GraphCommand {
  ...
  public static readonly RoutedCommand MarkDominanceFrontier =
    new RoutedCommand("MarkDominanceFrontier", typeof(GraphPanel));
  public static readonly RoutedCommand MarkPostDominanceFrontier =
    new RoutedCommand("MarkPostDominanceFrontier", typeof(GraphPanel));
