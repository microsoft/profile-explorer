...
public sealed class UTCCompilerInfoProvider : ICompilerInfoProvider {
  ...
  public List<FunctionTaskDefinition> ScriptFunctionTasks => LoadScriptFunctionTasks();
  ...
  public void ReloadSettings() {
    ...
    string path = App.GetSyntaxHighlightingFilePath();
  ...
  private List<FunctionTaskDefinition> LoadScriptFunctionTasks() {
    lock (lockObject_) {
      ...
      string[] files = App.GetFunctionTaskScripts();
