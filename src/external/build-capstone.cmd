...
cmake -G "Visual Studio 17 2022" -A ARM64 -DBUILD_SHARED_LIBS=1 -DCAPSTONE_BUILD_STATIC_RUNTIME=0 -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="/MP /GL" -DCMAKE_SHARED_LINKER_FLAGS="/LTCG" ../.
cmake --build .  --config Release -j 16
cd ..