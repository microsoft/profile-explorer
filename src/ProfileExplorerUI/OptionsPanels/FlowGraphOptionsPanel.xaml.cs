...
public partial class FlowGraphOptionsPanel : UserControl, IMvvmOptionsPanel {
  private FlowGraphOptionsPanelViewModel viewModel_;

  public FlowGraphOptionsPanel() {
    InitializeComponent();
    viewModel_ = new FlowGraphOptionsPanelViewModel();
  ...
  public void Initialize(FrameworkElement parent, SettingsBase settings, IUISession session) {
    viewModel_.Initialize(parent, (FlowGraphSettings)settings, session);
  }
