...
public partial class PreviewPopupOptionsPanel : UserControl, IMvvmOptionsPanel {
  private PreviewPopupOptionsPanelViewModel viewModel_;

  public PreviewPopupOptionsPanel() {
    InitializeComponent();
    viewModel_ = new PreviewPopupOptionsPanelViewModel();
  ...
  public void Initialize(FrameworkElement parent, SettingsBase settings, IUISession session) {
    viewModel_.Initialize(parent, (PreviewPopupSettings)settings, session);
  }
