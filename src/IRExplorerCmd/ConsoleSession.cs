...
public class ConsoleCompilerInfoProvider : ICompilerInfoProvider {
  ...
  Task<DebugFileSearchResult> ICompilerInfoProvider.
    FindDebugInfoFile(string imagePath, SymbolFileSourceOptions options) {
    throw new NotImplementedException();
  }

  Task<BinaryFileSearchResult> ICompilerInfoProvider.FindBinaryFile(BinaryFileDescriptor binaryFile,
...
public class ConsoleSession : ISession, IDisposable {
  ...
  public Task<bool> LoadProfileData(string profileFilePath, List<int> processIds, ProfileDataProviderOptions options,
                                    SymbolFileSourceOptions symbolOptions, ProfileDataReport report,
                                    ProfileLoadProgressHandler progressCallback, CancelableTask cancelableTask) {
    throw new NotImplementedException();
  }

  public Task<bool> LoadProfileData(RawProfileData data, List<int> processIds, ProfileDataProviderOptions options,
                                    SymbolFileSourceOptions symbolOptions, ProfileDataReport report,
                                    ProfileLoadProgressHandler progressCallback, CancelableTask cancelableTask) {
    throw new NotImplementedException();
  }
  ...
  public Task<bool> MarkProfileFunction(ProfileCallTreeNode node, ToolPanelKind sourcePanelKind,
  ...
  public Task<SectionSearchResult>
    SearchSectionAsync(SearchInfo searchInfo, IRTextSection section, IRDocument document) {
    throw new NotImplementedException();
  }
  ...
  public Task<bool> LoadProfileData(string profileFilePath, string binaryFilePath, ProfileDataProviderOptions options,
                                    ProfileLoadProgressHandler progressCallback, CancelableTask cancelableTask) {
    return null;
  }
