...
namespace Core.IR {
    ...
    public sealed class InstructionIR : TupleIR {
        ...
        public T OpcodeAs<T>() where T : System.Enum {
            return (T)Opcode;
        }
        ...
        public override bool Equals(object obj) {
            return obj is InstructionIR instruction &&
                   ...
                   EqualityComparer<List<OperandIR>>.Default.Equals(Sources, instruction.Sources) &&
                   EqualityComparer<List<OperandIR>>.Default.Equals(Destinations, instruction.Destinations);
        }
